...
class AgendamentoControllerTest {
    ...
    void deveRetornar403QuandoUsuarioNaoEhCliente() throws Exception {
        ...
        mockMvc.perform(post("/api/agendamentos")
                ...
                .andExpect(jsonPath("$", is("Apenas clientes podem criar agendamentos")));
    ...
    void deveRetornar400QuandoServicoNaoExiste() throws Exception {
        ...
        mockMvc.perform(post("/api/agendamentos")
                ...
                .andExpect(jsonPath("$", is("Serviço com ID 999 não existe")));
    ...
    void deveRetornar400QuandoFuncionarioNaoExiste() throws Exception {
        ...
        mockMvc.perform(post("/api/agendamentos")
                        ...
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", is("Funcionário com ID 999 não existe")));
    ...
    void deveRetornar422QuandoHorarioNaoEstaDisponivel() throws Exception {
        ...
        when(jwtService.extractClaim(eq(validJwtToken), eq("role")))
                .thenReturn("CLIENTE");
        when(agendamentoService.criarAgendamento(eq(clienteId), any(AgendamentoRequestDto.class)))
                .thenThrow(new IllegalArgumentException("Horário não disponível para este funcionário"));
        ...
        mockMvc.perform(post("/api/agendamentos")
                ...
                .andExpect(jsonPath("$", is("Horário não disponível para este funcionário")));
    ...
    void deveRetornar422QuandoFuncionarioNaoExecutaServico() throws Exception {
        ...
        mockMvc.perform(post("/api/agendamentos")
                        ...
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isUnprocessableEntity())
                .andExpect(jsonPath("$", is("Funcionário não executa este serviço")));
    ...
    void deveRetornar422QuandoDataEhNoPasado() throws Exception {
        ...
        when(jwtService.extractClaim(eq(validJwtToken), eq("role")))
                .thenReturn("CLIENTE");
        when(agendamentoService.criarAgendamento(eq(clienteId), any(AgendamentoRequestDto.class)))
                .thenThrow(new IllegalArgumentException("Data/hora do agendamento não pode ser no passado"));
        ...
        mockMvc.perform(post("/api/agendamentos")
                        ...
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isUnprocessableEntity())
                .andExpect(jsonPath("$", is("Data/hora do agendamento não pode ser no passado")));
    ...
    void deveRetornar500EmCasoDeErroInterno() throws Exception {
        ...
        mockMvc.perform(post("/api/agendamentos")
                ...
                .andExpect(jsonPath("$", is("Erro ao criar agendamento: Erro inesperado no banco de dados")));
