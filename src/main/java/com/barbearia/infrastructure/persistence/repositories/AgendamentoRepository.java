...
public interface AgendamentoRepository extends JpaRepository<JpaAgendamento, Long> {
         ...
         * @param dataInicio  Data/hora inicial do período
         * @param dataFim     Data/hora final do período
         * @return Lista de arrays com [servicoId, servicoNome, totalRealizacoes,
         *         faturamentoTotal]
         */
        @Query(value = """
                        SELECT
        ...
        /**
         * Busca agendamentos futuros criados recentemente (últimos N dias).
         * 
         * @param clienteId  ID do cliente
         * @param agora      Data/hora atual para comparar se é futuro
         * @param dataLimite Data/hora limite (agora - N dias) para filtrar criação
         *                   recente
        ...
        @Query("SELECT a FROM JpaAgendamento a " +
                        ...
                        "AND a.dataCriacao >= :dataLimite " +
                        "ORDER BY a.dataCriacao DESC")
        List<JpaAgendamento> findRecentesFuturosByClienteId(
                        @Param("clienteId") Long clienteId,
                        @Param("agora") LocalDateTime agora,
                        @Param("dataLimite") LocalDateTime dataLimite);

        /**
         * Busca agendamentos concluídos recentemente (últimos N dias).
         * 
         * @param clienteId  ID do cliente
         * @param dataLimite Data/hora limite (agora - N dias)
         * @param status     Status CONCLUIDO
        ...
        @Query("SELECT a FROM JpaAgendamento a " +
                        "WHERE a.clienteId = :clienteId " +
                        "AND a.status = :status " +
                        "AND a.dataHora >= :dataLimite " +
                        "ORDER BY a.dataHora DESC")
        List<JpaAgendamento> findConcluidosRecentesByClienteId(
                        @Param("clienteId") Long clienteId,
                        @Param("dataLimite") LocalDateTime dataLimite,
                        @Param("status") com.barbearia.domain.enums.StatusAgendamento status);
