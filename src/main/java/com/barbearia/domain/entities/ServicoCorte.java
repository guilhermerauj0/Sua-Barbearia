...
/**
 * Subclasse concreta de Servico que representa um Serviço de Corte.
 * 
 ...
 */
public class ServicoCorte extends Servico {
    
    public ServicoCorte() {
        super();
    }
    
    public ServicoCorte(Long id, String nome, String descricao, BigDecimal preco, 
