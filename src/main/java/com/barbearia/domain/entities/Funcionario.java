 ...
 * 
 * Cada funcionário possui um perfil profissional (barbeiro, manicure, esteticista, colorista)
...
public class Funcionario {
    ...
    public Funcionario(Long id, String nome, String email, String telefone, Long barbeariaId, boolean ativo, TipoPerfil tipoPerfil) {
        this.id = id;
        this.barbeariaId = barbeariaId;
        this.nome = nome;
        this.email = email;
